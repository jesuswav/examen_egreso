...
import { personAdd,duplicate, barChart, duplicateOutline, statsChartOutline, book, bookOutline } from 'ionicons/icons';
...
export class AdminTabsPage implements OnInit {
  ...
  constructor(private router: Router, private authService: AuthService) { 
    addIcons({personAdd,bookOutline,duplicateOutline,statsChartOutline,book,duplicate,barChart});
  }
