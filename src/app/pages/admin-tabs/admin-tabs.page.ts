...
import { personAdd,duplicate, barChart, duplicateOutline, statsChartOutline } from 'ionicons/icons';
...
export class AdminTabsPage implements OnInit {
  ...
  constructor(private router: Router, private authService: AuthService) { 
    addIcons({personAdd,duplicateOutline,statsChartOutline,duplicate,barChart});
  }
